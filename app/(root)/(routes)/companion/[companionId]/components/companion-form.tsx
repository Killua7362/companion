            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 p-10">
                <div className="space-y-2 w-full ">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Generatl informiation of about your companion
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField name="name" control={form.control} render={({field})=>(
                        <FormItem className="col-span-2 md:col-span-1">
                            ...
                            <FormControl>
                                <Input disabled={isLoading} placeholder="Killua" {...field}/>
                            </FormControl>
                            <FormDescription>
                    ...
                    <FormField name="description" control={form.control} render={({field})=>(
                        <FormItem className="col-span-2 md:col-span-1">
                            ...
                            <FormControl>
                                <Input disabled={isLoading} placeholder="From Zoldyk family" {...field}/>
                            </FormControl>
                            <FormDescription>
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <FormDescription>
                                Select a category for companion
                            </FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                ...
                <div className="space-y-2 w-full">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Detailed instructions fo the companion behaviour
                        </p>
                    </div>
